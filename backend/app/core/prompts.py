...
## A4篇幅控制
- 简历排版为A4纸（210×297mm），内容需填充但不超过1页
- 专业技能: 2-3行，8-15项
- 每个项目: 4-5行（含技术栈+描述+3-4条职责）
- 每个工作经历: 4-5行
- 个人总结: 3-4行
- 总输出控制在1000-1800字"""
...
6. **A4篇幅控制（重要）**:
   - 简历排版为A4纸（210×297mm），内容需要填充但不超过1页
   - 【专业技能】：精选8-15项与JD最匹配的技能，用逗号分隔，2-3行
   - 【项目经历】：精选2-3个最匹配的项目，每个项目用4-5行（含技术栈、描述、3-4条职责要点）
   - 【工作/实习经历】（如有）：每个经历4-5行，最多保留2个最相关经历
   - 【个人总结】：2-3句话，3-4行
   - 如果素材过多：优先保留与JD方向一致的，同方向则优先保留有量化成果的
   - 如果素材不足：不要强行拉长——真实的精简比虚构的充实好
   - 总输出控制在1000-1800字"""
